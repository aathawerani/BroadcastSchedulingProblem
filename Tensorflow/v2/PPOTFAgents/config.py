...
def GetParams():
    ...
    Variables = collections.namedtuple('params',
        [
            'chances', 'discount_factor', 'seed', 'num_environment_steps', 'collect_episodes_per_iteration',
            'num_parallel_environments', 'replay_buffer_capacity', 'num_epochs', 'learning_rate',
